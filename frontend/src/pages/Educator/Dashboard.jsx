      ...
      <div className="w-full px-6 py-10   bg-gray-50 space-y-10">
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-xl shadow-md p-6 flex flex-col md:flex-row items-center gap-6">
          ...
          <div className="text-center md:text-left space-y-1">
            ...
            <h1 className='text-xl font-semibold text-gray-800'>Total Earning 
              :<span className='font-light text-gray-900'>₹{totalEarning.toLocaleString()}</span> 
               </h1>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <ResponsiveContainer width="100%" height={300}>
             <BarChart data={CourseProgressData}>
              ...
              <YAxis />
              <Tooltip />
              <Bar dataKey="lectures" fill="#8884d8" radius={[5,5,0,0]} />
             </BarChart>
            </ResponsiveContainer>
          </div>
            ...
            <ResponsiveContainer width="100%" height={300}>
             <BarChart data={EnrollData}>
              ...
              <YAxis />
              <Tooltip />
              <Bar dataKey="enrolled" fill="#8884d8" radius={[5,5,0,0]} />
             </BarChart>
            </ResponsiveContainer>
          </div>
